...
### Dev
In order to add a trait to Artemis/Athena/Dionysus, please refer to the [dev](https://github.com/excellent-ae/zannc-Droppable_Gods/tree/main/dev) folder, which shows what is needed to add a boon to the God Pool - and allow it to be used along-side this mod.
For a full working example of multiple boons being added, refer to my [other mod, Practical Gods](https://github.com/excellent-ae/zannc-Practical_Gods), which was made to work with this mod specifically.
